...
VALUES
    ('Notification1', 'Event1', 'http://endpoint1.com', GETDATE(), 1, 1),  
    ('Notification2', 'Event2', 'http://endpoint2.com', GETDATE(), 1, 1),  
    ('Notification3', 'Event3', 'http://endpoint3.com', GETDATE(), 2, 1),  
    ('Notification4', 'Event4', 'http://endpoint4.com', GETDATE(), 3, 0),  
    ('Notification5', 'Event5', 'http://endpoint5.com', GETDATE(), 4, 1),  
    ('Notification6', 'Event6', 'http://endpoint6.com', GETDATE(), 5, 1), 
    ('Notification7', 'Event7', 'http://endpoint7.com', GETDATE(), 6, 0),  
    ('Notification8', 'Event8', 'http://endpoint8.com', GETDATE(), 7, 1), 
    ('Notification9', 'Event9', 'http://endpoint9.com', GETDATE(), 8, 1), 
    ('Notification10', 'Event10', 'http://endpoint10.com', GETDATE(), 1, 1); 
